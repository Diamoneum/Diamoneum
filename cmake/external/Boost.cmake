...
if(EXISTS "$ENV{Boost_DIR}" AND IS_DIRECTORY "$ENV{Boost_DIR}")
    ...
    find_package(Boost REQUIRED COMPONENTS ${Boost_COMPONENTS} REQUIRED NO_MODULE)
else()
    ...
    find_package(Boost QUIET REQUIRED COMPONENTS ${Boost_COMPONENTS} REQUIRED NO_MODULE)
endif()
